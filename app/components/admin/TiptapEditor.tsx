...
interface TiptapEditorProps {
  ...
  placeholder?: string;
  /** Supabase Storage bucket for inline image uploads (default: "post-images") */
  bucket?: string;
}
...
function ToolbarButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "flex h-8 w-8 items-center justify-center rounded text-sm transition-colors disabled:opacity-40 disabled:cursor-not-allowed",
        active
          ? "bg-[#09418C] text-white"
 ...
 * Outputs and accepts HTML content.
  ...
  return (
    <div className="rounded-lg border border-gray-300 overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-1 border-b border-gray-200 bg-gray-50 px-2 py-1.5">
        ...
        <div className="w-px h-5 bg-gray-300 mx-1" />
        <ToolbarButton onClick={addLink} active={editor.isActive("link")} title="เพิ่ม Link">
          <LinkIcon size={14} />
        </ToolbarButton>
        {/* Image upload button */}
        <ToolbarButton
